...
import { starters, beverages } from './food-items';
...
@Component({
  selector: 'app-imperfecto',
  templateUrl: './imperfecto.component.html',
  styleUrls: ['./imperfecto.component.scss']
})
export class ImperfectoComponent implements OnInit {
